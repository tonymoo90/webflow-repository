...
.then (data => {
      ...
      $('.wager-countdown').each(function(index) { 
        if  ($(this).text() === "CLOSED" ) {
          ...
          $('.button-5[data-bind='+ JSON.stringify($(this)[0].dataset.bind) + ']').next('style', "display: none;")
          $('.button-3[data-bind='+ JSON.stringify($(this)[0].dataset.bind) + ']').attr('style', "display: none;")
          $('.button-3[data-bind='+ JSON.stringify($(this)[0].dataset.bind) + ']').next('style', "display: none;")
        } 
      })
